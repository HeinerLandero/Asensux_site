      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {teamMembers.map((member, idx) => (
            <motion.div
              key={member.name}
              className="group relative rounded-2xl overflow-hidden border border-white/5 hover:border-caribbeanGreen/20 transition-all duration-500 bg-richBlack/50"
            ...
            >
              ...
              <div className="relative aspect-[3/4] overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-richBlack via-richBlack/20 to-transparent" />
                ...
                <div className="absolute bottom-4 left-0 right-0 flex justify-center gap-3 opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-300">
                  <a
                    href="#"
                    className="w-9 h-9 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center hover:bg-caribbeanGreen/20 transition-colors"
